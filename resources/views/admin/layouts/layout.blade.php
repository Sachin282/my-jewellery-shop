...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{url('assets/admin/css/dataTables.bootstrap.min.css')}}"> -->
    <!-- Bootstrap social button library -->
    <link rel="stylesheet" href="{{url('assets/admin/css/bootstrap-social.css')}}">
    <!-- Bootstrap select -->
    <link rel="stylesheet" href="{{url('assets/admin/css/bootstrap-select.css')}}">
    <!-- Bootstrap file input -->
    <link rel="stylesheet" href="{{url('assets/admin/css/fileinput.min.css')}}">
    <!-- Awesome Bootstrap checkbox -->
    <link rel="stylesheet" href="{{url('assets/admin/css/awesome-bootstrap-checkbox.css')}}">
    <!-- Admin Stye -->
...
<body>
	...
	<script src="{{url('assets/admin/js/dataTables.bootstrap.min.js')}}"></script>
	<script src="{{url('assets/admin/js/Chart.min.js')}}"></script>
	<script src="{{url('assets/admin/js/fileinput.js')}}"></script>
	<script src="{{url('assets/admin/js/chartData.js')}}"></script>
