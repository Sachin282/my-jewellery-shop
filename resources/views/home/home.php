...
<head>
    ...
    <title>Sai Jewellers - Home</title>
	<!-- CSS -->
...
<body id="home" class="homepage">
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(images/slider/hgsggs_right.png);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2 style="font-size:2em"><span>Sai Jewellers presents</span><br>Har Ghar Sona<br>Ghar Ghar Sona . .</h2>
                                    <p>Your lucky gold coin is waiting for you.<br>Get your lucky gold coin now by 3 easy steps.</p>
                                    <a class="btn btn-primary btn-lg" href="#">Get my Gold coin</a>
                                    <br><br><br><a href="https://www.freepik.com/free-photos-vectors/background">Background vector created by freepik - www.freepik.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="cta" class="wow fadeIn">
        <div class="container" style="background-image: url(images/imgs/falling_gold_coins.png); opacity: 0.5;">
            <div class="row">
                <div class="col-sm-9">
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Har Ghar Sona Ghar Ghar Sona</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        <div class="pull-left">
                            <i class="fa fa-quantity"></i>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading">Select gold coin weight</h4>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Pay Advance Booking Down Payment</h4>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Pay Easy Installments</h4>
                    ...
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Get your 24 karet Gold coint</h4>
