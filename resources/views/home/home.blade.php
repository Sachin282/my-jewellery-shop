     ...
     <section id="cta">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">Sai Jewellers is Trustful and Reliable Shop</span></h2>
...
<section id="cta">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">Some Facts about Jewellery</span></h2>
                <ul class="text-left">
                    <li type="none"><h3>Q. When was jewelry first invented?</h3></li>
                    <li>
                        <p>The Greeks started using gold and gems in jewellery in 1600 BC, although beads shaped as shells and animals were produced widely in earlier times. Around 1500 BC, the main techniques of working gold in Greece included casting, twisting bars, and making wire.
                        </p>
                    </li>
                    <li type="none"><h3>Q. Who made the first necklace?</h3></li>
                    <li type="square"><h4>Ancient civilizations</h4>
                        <p>
                            In Ancient Mesopotamia, cylinder seals were often strung and worn as jewelry. In Ancient Babylon, necklaces were made of carnelian, lapis lazuli, agate, and gold, which was also made into gold chains. Ancient Sumerians created necklaces and beads from gold, silver, lapis lazuli and carnelian.
                        </p>
                    </li>
                    <li type="none"><h3>Q. What is a collar necklace?</h3></li>
                    <li>
                        <p>
                            In jewelry, a collar is an ornament for the neck. Collar is an older word for necklace, and is usually reserved today for a necklace that lies flat to the body rather than hanging freely. In contemporary fine jewelry, collar necklaces are 14 inches in chain length.
                        </p>
                    </li>
                    <li type="none"><h3>Q. Which is the diamond city of India?</h3></li>
                    <li>
                        Surat, famous for its diamond cutting and polishing is known as the Diamond City of India.
                    </li>
                    <li type="none"><h3>Q. How are ornaments made?</h3></li>
                    <li>
                        The popularity of these decorations grew into the production of glass figures made by highly skilled artisans with clay molds. The artisans heated a glass tube over a flame, then inserted the tube into a clay mold, blowing the heated glass to expand into the shape of the mold.
                    </li>
                </ul>
            </div>
        </div>
 ...
 <section id="Designs">
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        <div class="pull-right">
                            <div class="section-header">
                                <h2 class="text-center wow fadeInDown custom-heading">We have variety of Jewellery Designs</h2>
                            </div>
                        </div>
                        <div class="media-body">
                             <p>
                            ...
                            <h4 class="media-heading custom-heading">This list of jewelry types is a listing of most types of jewelry made.</h4>
                            <ul class="custom-heading-content">
                                <li>Hair and head ornaments</li>
                                <li>Crowns, including: Coronet. Corolla. Diadem or circlet. Kokoshnik. Makuṭa. Pschent and khepresh.Tiara.</li>
                                <li>Earrings.</li>
                                <li>Fascinator.</li>
                                <li>Hairpin.</li>
                                <li>Hatpin.</li>
                                <li>Sarpech or aigrette.</li>
                            </ul>
                            <!-- Button trigger modal -->
                            <br><br>
                            <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
        ...
        <div class="ws_bullets">
            <div>
                <a href="#" title="sj1"><span>1</span></a>
                <a href="#" title="sj10"><span>2</span></a>
                <a href="#" title="sj11"><span>3</span></a>
                <a href="#" title="sj12"><span>4</span></a>
                <a href="#" title="sj13"><span>5</span></a>
                <a href="#" title="sj14"><span>6</span></a>
                <a href="#" title="sj15"><span>7</span></a>
                <a href="#" title="sj16"><span>8</span></a>
                <a href="#" title="sj17"><span>9</span></a>
                <a href="#" title="sj18"><span>10</span></a>
                <a href="#" title="sj19"><span>11</span></a>
                <a href="#" title="sj2"><span>12</span></a>
                <a href="#" title="sj20"><span>13</span></a>
                <a href="#" title="sj21"><span>14</span></a>
                <a href="#" title="sj22"><span>15</span></a>
                <a href="#" title="sj23"><span>16</span></a>
                <a href="#" title="sj24"><span>17</span></a>
                <a href="#" title="sj3"><span>18</span></a>
                <a href="#" title="sj4"><span>19</span></a>
                <a href="#" title="sj5"><span>20</span></a>
                <a href="#" title="sj6"><span>21</span></a>
                <a href="#" title="sj7"><span>22</span></a>
                <a href="#" title="sj8"><span>23</span></a>
                <a href="#" title="sj9"><span>24</span></a>
            </div>
        </div>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>We take Orders in case of Emergency like jewellery needed for wedding,Gift,Function,etc. We also provide ready made jewelleres in effective and under budget.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>We clean all types of jewelleries. we have professional and responsible employees for all aur jewellery work.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
...
s1.async=true;
s1.src='https://embed.tawk.to/5d54f39d77aa790be32efc4c/default';
s1.charset='UTF-8';
